import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{i as t,r as n}from"./react-D4Cofj83.js";import{K as r,M as i,N as a,k as o}from"./mui-ByWCFDxG.js";import{i as s,n as c}from"./hooks-DPg459AI.js";import{E as l,l as u}from"./ui-BOd2w4Z2.js";import{p as d}from"./styled-ObQ8HfU6.js";import{_ as f,h as p,n as m,t as h}from"./reader-client-6ImHFzQ9.js";import{i as g,u as _}from"./util-rom-CxHYua_s.js";import{c as v}from"./index-CYllX9fj.js";import{n as y,t as b}from"./modal-header-C2bqX66I.js";import{t as x}from"./modal-footer-C-HNyuAC.js";import{t as S}from"./error-with-icon-JgWmEqix.js";import{t as C}from"./drag-and-drop-input-7dUoW1Sk.js";import{t as w}from"./use-async-data-BlYT4ftm.js";var T=t(),E=e(n(),1),D=()=>{let[e,t]=(0,E.useState)(0),[n,r]=(0,E.useState)(null),{data:i,isLoading:a,error:o,execute:s}=w({fetchFn:(0,E.useCallback)(e=>e?new Promise((n,i)=>{let a=e.romFile.name.toLowerCase().endsWith(`.gba`)?e.romFile.size:void 0;e.romFile.arrayBuffer().then(async i=>{await p(e.esp32IP,i,a,{onProgress:e=>{r(e),t(e.percent*.67)}}),await f(e.esp32IP,i,a,{onProgress:e=>{r(e),t(67+e.percent*.33)}}),t(100),n(!0)}).catch(i)}):Promise.reject(Error(`fetchProps is required`)),[]),clearDataOnLoad:!0});return{data:i,isLoading:a,error:o,execute:s,progress:e,readerProgress:n}},O=v.div`
  display: flex;
...
`,A=[`.gba`,`.gbc`,`.gb`],j=v.div`
  background-color: ${e=>e.theme.modalBorder};
  border-radius: 4px;
  position: relative;
  height: 24px;
  width: 100%;
...
//# sourceMappingURL=upload-rom-reflash-dR5TpAZb.js.map